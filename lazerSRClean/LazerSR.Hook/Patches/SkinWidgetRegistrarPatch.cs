...
{
    private static readonly Type[] LazerSRWidgets = [typeof(BoxElementPlus), typeof(ClassicAccuracyWidget), typeof(DanInfoWidget), typeof(DanProfileWidget), typeof(KeyViewerWidget), typeof(ManiaPositionAdjustWidget), typeof(MsdSkillsetWidget), typeof(PatternCopyStatusWidget), typeof(PersonalSunnyWidget), typeof(RealtimeSunnyWidget), typeof(ReplayCompareWidget), typeof(SectionTimerWidget), typeof(StrainGraphWidget), typeof(SunnyPPWidget), typeof(SunnySortWidget), typeof(TrainingAccuracyWidget), typeof(TrainingStatusWidget)];
